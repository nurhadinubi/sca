        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" autocomplete="off" method="POST" action="{{ route('division.store') }}">
                        @csrf
                        <div class="col-md-5">
                            <label for="code" class="form-label">Kode</label>
                            <input autocomplete="off" type="text" class="form-control  @error('code') is-invalid	@enderror" id="code"
                                name="code" value="{{ old('code') ? old('code') : '' }}" placeholder="Kode" />
                            @error('code')
                        ...
                        <div class="col-md-7">
                            ...
                            <input autocomplete="off" type="text" class="form-control  @error('description') is-invalid	@enderror" id="description"
                                name="description" value="{{ old('description') ? old('description') : '' }}" placeholder="Deskripsi" />
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
