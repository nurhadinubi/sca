...
@section('title', 'Edit Draft Scale Up')
...
@section('content')
    ...
    @endif
        <div class="card">
            <div class="card-body">
                <form action="{{ route('draft.scaleup.update', ['id'=>$header->id]) }}" id="form-scaleup" method="post" onkeydown="return event.key != 'Enter';"
                    data-getMaterial="{{ route('api.getMaterial') }}"
                    data-getMaterialById="{{ route('api.getMaterialById') }}" data-getProducts = "{{ route('getProducts') }}"
                    data-getItemById = "{{ route('draft.scaleup.getItemById') }}"
                    data-getItemcategory = "{{ route('scaleup.getItemcategory') }}"
                    data-sessionGetSubCategory = "{{ route('draft.scaleup.sessionGetSubCategory') }}"
                    data-updateItemcategory = "{{ route('draft.scaleup.updateItemcategory') }}"
                    data-deleteItemcategory = "{{ route('draft.scaleup.deleteItemcategory') }}"
                    data-deleteItem = "{{ route('draft.scaleup.deleteItem') }}" 
                        ...
                        <div class="collapse show" id="collapseExample">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="product_select" class="form-label required">Pilih Kode Produk CI</label>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('rev0') is-invalid @enderror"
                                        id="rev0" name="rev0" value="{{ old('rev0') ? old('rev0') : $header->rev0 }}"
                                        placeholder="Rev00" />
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="input-group-text col-sm-2" type="text"
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        <a href="{{ route('draft.scaleup.index') }}" class="btn btn-outline-info">Kembali</a>
                        <button class="btn btn-outline-info" name="action" value="draft"
                            type="submit">Simpan Draft</button>
                        <button class="btn btn-primary" name="action" value="save" type="submit">Submit
                            Scaleup</button>
                    </div>
                </form>
            </div>
            ...
            $(document).ready(function() {
                ...
                function renderItems(itemCategory, itemCart) {
                    ...
                    i.description ? i.description : i.text
                        ...
                        const grandTotalTfoot = $("<tfoot>").append(`
                            <tr>
                                <th colspan="2" width="55%" class="text-center">Total Keseluruhan</th>
                ...
                function selctMaterial(el, parent, old = null) {
                    ...
                    $(el).select2({
                        ...
                        language: {
                            noResults: function() {
                                return `<a href="/sap/create/rm" type="button"
                ...
                $("#add-category").on("click", function(e) {
                    ...
                    if (
                        ...
                        if ($("#id_itemcategory_action").val() == "edit") {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "/draft/scaleup/itemCategory",
                                data: {
                                    _token: csrftoken,
