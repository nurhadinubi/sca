...
@section('title', $title??'Edit Formula Semi finish')
    ...
    <div class="">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="" id="form-scaleup" method="post" onkeydown="return event.key != 'Enter';"
                       ...
                       <div class="collapse show" id="collapseExample">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="bg-white form-control  @error('IssueDate') is-invalid @enderror"
                                        id="IssueDate" name="IssueDate"
                                        value="{{ old('IssueDate') ? old('IssueDate') : '' }}"
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="doc_number" class="form-label required">Tanggal Dokumen</label>
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        ...
                        <button class="btn btn-primary float-end" name="action" value="save" type="submit">Submit Formula</button>
                    </div>
                </form>
            </div>
        </div>
