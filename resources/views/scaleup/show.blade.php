            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <span class="col-sm-3">Total Berat</span>
                            <span class="col-sm-9">: {{ $header->total . ' ' . $header->base_uom }}</span>
                        </div>
                        <div class="row">
                            <span class="col-sm-3">Berat Perkemasan</span>
                                            ...
                                            @foreach ($detail as $item)
                                                ...
                                                @endphp
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->percent }} %</td>
                                                        <td>{{ ($header->total * $item->percent) / 100 }}</td>
                                                        <td>{{ $item->uom }}</td>
                                ...
                                @foreach ($approval as $item)
                                    <div class="step step-completed">
                                        @if ($item->status == 'P')
                                            ...
                                            <div class="row mt-4">
                                                <h6> {{ $item->name }} </h6>
                                                <p>{{ 'Approval level : ' .$item->level }}</p>
                                                <span class="text-xs text-muted">
                                                
                                                   Dikirim: {{ $item->sent_at? \Carbon\carbon::parse($item->sent_at)->format('d-M-Y , H:m:s'):'-' }}
                                                </span>
                                            </div>
                                        @endif
                                        @if ($item->status == 'A')
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <span class="text-xs text-muted">
                                                    ...
                                                    Diapprove : {{ \Carbon\carbon::parse($item->updated_at)->format('d-M-Y , h:m:s') }}
                                                </span>
