                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="doctype" id="doctype" class="form-select">
                                                    <option value="">Otomatis terisi saat pilih kode produk</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('sap_code') ? old('sap_code') : '' }}"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('material_description') ? old('material_description') : '' }}"
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="input-group-text col-sm-2" type="text" value="KG"
                            ...
                            @if (count($itemCategory))
                                ...
                                <div class="col-12 mt-4">
                                    <table class="table table-bordered">
                                        <tfoot>
                                            <tr>
                                                <th width="55%" colspan="2" class="text-center">Total Keseluruhan:
                                                </th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="item_code" value="" id="item_code" >
                    <input type="text" name="item_description" value="" id="item_description" >
                    <input type="text" name="item_action" value="add" id="item_action" >
                    <input type="text" name="uniqid" value="" id="uniqid" >
                    ...
                    i.description ? i.description : i.text
                            ...
                            if (filteredItems.length > 0) {
                                ...
                                const subTotalRow = $("<tr>").append(`
                                    ...
                                    <td width="10%" class='percent'>${totalPercent}%</td>
                                    <td width="10%" class='qty'>${totalQty}</td>
                                    <td width="10%"></td>
                                    <td width="15%"></td>
